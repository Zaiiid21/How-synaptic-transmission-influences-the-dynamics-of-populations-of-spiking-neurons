...
#VARIABLES
###############################################################################
N = 100      # We define the global parameters
vres = 100
vref = -vres/10
ti = 0
Tmax= 10
...
delta = 1
x0 = -5
SD = 1 #Where I want the Fr to start
...
def I(t,mu,spike,J=coupling,I=Ixternal):
    return mu + J*I + I0(t) 
...
sio.savemat('V_matlabnosincro.mat', {'V_matlabnosinc': v})
sio.savemat('S_matlabnoresincro.mat', {'S_matlabnosinc': S})
